if exists (select 1 from sys.objects where object_id = object_id('dbo.FactPersonFiscalYear_get'))
   set noexec on
go
create procedure FactPersonFiscalYear_get as
begin
...
alter procedure FactPersonFiscalYear_get as
