if exists (select 1 from sys.objects where object_id = object_id('dbo.CfA_Student_Metrics_Academic_Plan__c'))
   set noexec on
go
create procedure dbo.[CfA_Student_Metrics_Academic_Plan__c] as
begin
...
CREATE PROC [dbo].[CfA_Student_Metrics_Academic_Plan__c]
